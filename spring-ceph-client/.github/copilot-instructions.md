...
- Java 개발 규칙은 [java-project-rules.instructions.md](.github/instructions/java-project-rules.instructions.md)를 따른다.
- AI 채팅/터미널 실행 운영 규칙은 [ai-chat.instructions.md](.github/instructions/ai-chat.instructions.md)를 따른다.
