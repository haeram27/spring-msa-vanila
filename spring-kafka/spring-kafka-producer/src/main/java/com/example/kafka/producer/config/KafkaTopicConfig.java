...
public class KafkaTopicConfig {
    ...
    public NewTopic topic1() {
        ...
        // 복제 계수(Replication Factor)는 "토픽의 데이터를 몇 개의 카프카 브로커에 복사하여 저장할 것인가"를 나타내는 설정 값, 복제 계수 만큼의 브로커가 없는 경우 토픽 생성 실패
        // 복제 계수를 사용하려면, 브로커를 클러스터 구성해야 하며, 복제 계수는 브로커 수보다 작거나 같아야 한다. (복제 계수 > 브로커 수인 경우 토픽 생성 실패)
