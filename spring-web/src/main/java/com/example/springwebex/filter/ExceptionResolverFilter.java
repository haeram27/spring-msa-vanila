...
import com.example.springwebex.util.ErrorCode;
import com.example.springwebex.util.ResponseJsonObject;
...
public class ExceptionResolverFilter implements Filter {
    ...
    static {
        ResponseJsonObject responseObject = new ResponseJsonObject();
        responseObject.setErrorCode(String.valueOf(ErrorCode.UNKNOWN.getCode()));
        responseObject.setErrorMsg(ErrorCode.UNKNOWN.getDefaultMessage());
