...
public final class JsonUtil {
    ...
    public static <T> T deserialize(byte[] jsonBytes, Class<T> clazz) throws IOException {
    ...
    public static <T> T deserialize(String jsonString, TypeReference<T> ref) throws IOException {
        if (StringUtil.isEmpty(jsonString)) {
            throw new IllegalArgumentException("jsonString must not be null or empty.");
        }
    ...
    public static <T> T deserialize(byte[] jsonBytes, TypeReference<T> ref) throws IOException {
        if (CollectionUtil.isEmpty(jsonBytes)) {
            throw new IllegalArgumentException("jsonBytes must not be null or empty.");
        }
